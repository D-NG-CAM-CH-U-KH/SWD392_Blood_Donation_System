    ...
    <div>
      <Box sx={{ display: 'flex', justifyContent: 'space-around', mt: 5 }}>
        <Box sx={{ display: 'flex', padding: 3, borderRadius: '16px', backgroundColor: RED_300, gap: 2 }}>
          <img src='/images/drop.png' style={{ width: 100, height: 100 }} />
        ...
        <Box sx={{ display: 'flex', padding: 3, borderRadius: '16px', backgroundColor: RED_300, gap: 2 }}>
          <img src='/images/give.png' style={{ width: 100, height: 100 }} />
          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <Box sx={{ display: 'flex', padding: 3, borderRadius: '16px', backgroundColor: RED_300, gap: 2 }}>
          <img src='/images/calendar.png' style={{ width: 100, height: 100 }} />
          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
